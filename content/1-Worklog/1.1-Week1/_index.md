...
| 6 | - Install and configure **VS Code** and **AWS CLI** for the learning process | 26/06/2026 | 27/06/2026 | |
...
* Learned how to navigate the AWS Management Console and use the AWS CLI.
* Installed and configured **VS Code** and the **AWS CLI** with the appropriate credentials and region settings.
* Practiced basic commands to check EC2 resources and account configuration.
* Launched an EC2 instance, connected to it, and attached an EBS volume.
