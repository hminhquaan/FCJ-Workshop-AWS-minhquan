...
* Understood Amazon Aurora (MySQL) and relational database concepts.
* Designed the EDMS entity-relationship model.
* Created the S3 bucket for document storage.
* Created the Aurora cluster and noted its endpoint.
* Set up IAM roles and a Cognito User Pool with three role groups.
* Prepared the foundation for the backend development phase.
